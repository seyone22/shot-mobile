...
fun BowEquipmentScreen(
    ...
    var bowToEdit by remember { mutableStateOf<BowProfile?>(null) }

    // State for Delete Confirmation
    var bowToDelete by remember { mutableStateOf<BowProfile?>(null) }
...
@Composable
fun BowProfileCard(
    bow: BowProfile, onEdit: () -> Unit, onDelete: () -> Unit, onClick: () -> Unit
) {
...
fun BowProfileBottomSheet(
    initialBow: BowProfile?, onDismiss: () -> Unit, onSave: (BowProfile) -> Unit
) {
